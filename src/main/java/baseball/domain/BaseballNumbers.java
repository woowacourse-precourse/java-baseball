...
public class BaseballNumbers {
    ...
    public BaseballNumbers(List<BaseballNumber> baseballNumberList) {
        validateBaseballNumberDuplication(baseballNumberList);
        validateBaseballNumbersLength(baseballNumberList);
    ...
    private void validateBaseballNumbersLength(List<BaseballNumber> baseballNumberList) {
        if (baseballNumberList.size() != BASEBALL_NUMBERS_LENGTH) {
