...
public class RefereeTest {
    ...
    void scoring_위치가_다른_일치하는_수가_1개면_1볼() {
        ...
        String decision = referee.judge(game.getAnswer(), List.of(new Integer[]{2, 4, 5}));
    ...
    void scoring_위치가_같은_일치하는_수가_1개면_1스트라이크() {
        ...
        String decision = referee.judge(game.getAnswer(), List.of(new Integer[]{4, 2, 5}));
    ...
    void scoring_1볼_1스트라이크() {
        ...
        String decision = referee.judge(game.getAnswer(), List.of(new Integer[]{4, 2, 1}));
    ...
    void scoring_낫싱() {
        ...
        String decision = referee.judge(game.getAnswer(), List.of(new Integer[]{4, 5, 6}));
    ...
    void scoring_정답() {
        ...
        String decision = referee.judge(game.getAnswer(), List.of(new Integer[]{1, 2, 3}));
