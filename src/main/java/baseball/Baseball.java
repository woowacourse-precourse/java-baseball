...
public class Baseball {
    ...
    private final String CLOSE_MESSAGE = "애플리케이션을 종료합니다.";
    ...
    private final String GAME_OPTION_MESSAGE = "게임을 새로 시작하려면 1, 종료하려면 2를 입력하세요.";
    private final String GAME_OPTION_ERROR_MESSAGE = "1 또는 2를 입력하세요.";
    private final String INPUT_USER_NUMBER_MESSAGE = "숫자를 입력해주세요 : ";
    private final String INPUT_USER_NUMBER_ERROR_MESSAGE = "1부터 9까지의 서로 다른 3자리의 양의 정수를 입력하세요.";
