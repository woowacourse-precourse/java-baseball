...
public class Application {
    ...
    private static final String RESTART_MESSAGE = String.format("게임을 새로 시작하려면 %d, 종료하려면 %d를 입력하세요.", RESTART, END);
    ...
    private static final String RESTART_NUMBER_REGEX = String.format("[%d%d]", RESTART, END);
