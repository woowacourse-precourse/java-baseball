...
public class GameUtilsTest {
    ...
    void 사용자_입력() {
        ...
        assertThat(player.getBall()).isEqualTo(Arrays.asList(1,3,5));
    }
    ...
    void 난수_생성() {
        ...
        assertThat(computer.getBall().size()).isEqualTo(3);
        assertThat(computer.getBall().stream().distinct().count()).isEqualTo(3);
    }
    ...
    void 스트라이크_개수_반환() {
        ...
        int strike1 = Judge.getStrikeCount(answerNum1, playerNum1);
        assertThat(strike1).isEqualTo(2);

        List<Integer> answerNum2 = List.of(1, 2, 3);
        List<Integer> playerNum2 = List.of(3, 4, 1);
        int strike2 = Judge.getStrikeCount(answerNum2, playerNum2);
    ...
    void 볼_개수_반환() {
        ...
        int ball1 = Judge.getBallCount(answerNum1, playerNum1);
        assertThat(ball1).isEqualTo(1);

        List<Integer> answerNum2 = List.of(1, 2, 3);
        List<Integer> playerNum2 = List.of(3, 2, 1);
        int ball2 = Judge.getBallCount(answerNum2, playerNum2);
    ...
    @Test
    void 숫자_야구_게임_결과_출력() {
        GameResult gameResult = GameResult.createGame();
        gameResult.setGameResult(3, 0);
        OutputUtils.printGameResultView(gameResult);
    ...
    void 명령어_예외() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, game::getRestartOrExitFromPlayer);
