...
class OutputTest extends NsTest {
    ...
    private void checkExpect(int ball, int strike, String expect) {
        ...
        assertThat(gameMessage.getMassage().replace("\n",""))
                .isEqualTo(expect.replace("\n", ""));
    }
}