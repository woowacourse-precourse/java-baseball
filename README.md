...
- [O] 정답 숫자 정하는 기능
- [O] 입력된 숫자 저장 기능
- [O] 정답 숫자와 입력된 숫자를 비교 및 결과(볼, 스트라이크)를 출력하는 기능
- [O] 프로그램 시작, 종료 기능
- [] 잘못된 입력 시 예외 처리 기능
...
1. 정답 숫자 3개를 정한다.
2. 사용자에게 3개의 숫자를 입력받는다.
3. 사용자에게 입력받을 시 잘못된 입력을 하면 예외처리 (IllegalArgumentException을 발생)시킨 후 애플리케이션은 종료시킨다.
4. 입력된 값과 정답 값을 비교하여 경우에 따라 스트라이크, 볼, 낫싱을 출력한다.
5. 정답을 맞추면 "정답" 과 함께 게임이 종료된다.
