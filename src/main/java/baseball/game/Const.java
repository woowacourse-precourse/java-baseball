...
public class Const {
    ...
    public static String GAME_SCORE_STRIKE_BALL_MESSAGE = "%d볼 %d스트라이크\n";
    public static String GAME_SCORE_STRIKE_MESSAGE = "%d스트라이크\n";
    public static String GAME_SCORE_BALL_MESSAGE = "%d볼\n";
