...
public class Application {
    ...
    private static boolean isRestart() {
        ...
        ArgumentExcpetion.isException(
                restartCommand != RESTART_NUMBER && restartCommand != STOP_NUMBER,
                ArgumentExceptionMessage.COMMAND_NOT_FOUND);   // 입력받은 데이터가 Command와 일치하지 않는 경우
