...
public class NumberValidator implements Validator {
    ...
    public void validate(Object target) {
        List<Integer> targetIntegerList = (List<Integer>) target;
        targetIntegerList.forEach(number -> isNumberBetWeen1And9(number));
        isListSize3(targetIntegerList);
        isNumbersHavingDuplication(targetIntegerList);
    }
