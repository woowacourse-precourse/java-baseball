...
public class NumberGenerator {
    ...
    private static final String GET_NUMBER_MESSAGE = "숫자를 입력하세요 : ";
    private static final String SUCCESS_MESSAGE = NumberGenerator.NUMBER_LENGTH + "개 숫자 모두 맞추셨습니다! 게임 종료";
