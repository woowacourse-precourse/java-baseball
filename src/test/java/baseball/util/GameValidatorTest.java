...
class GameValidatorTest {
    ...
    void isValidLength() {
        ...
        //when
        boolean result = GameValidator.isInvalidLength(number);
    ...
    void containsAllDigit() {
        ...
        //when
        boolean result = GameValidator.containsNotDigit(number);
    ...
    void containsValidRangeDigit() {
        ...
        //when
        boolean result = GameValidator.containsInvalidRangeDigit(number);
    ...
    void containsDuplication() {
        ...
        //when
        boolean result = GameValidator.containsDuplication(number);
    ...
    void validateInvalidLength() {
        ...
        //then
        Assertions.assertThatThrownBy(() -> GameValidator.validate(number))
