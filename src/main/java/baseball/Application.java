...
public class Application {
    ...
    public static HashMap<String, Integer> chooseComputerNumber() {
    ...
    public static boolean isDistinctNumber(String number) {
    ...
    public static boolean oneOrTwo(String continueornot) {
        return Pattern.matches("[1, 2]", continueornot);
    }

    public static Integer selectContinueOrNot() {
    ...
    public static boolean inputAndMatchNumber(HashMap computer) {
    ...
    public static int[] countStrikeBall(HashMap com, String num, Integer idx, int[] res) {
    ...
    public static int[] matchNumber(HashMap com, String user) {
        int[] res = {0, 0};
        for(int i=0; i<3; i++) {
